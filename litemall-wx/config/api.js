...
// 云平台部署时使用
// var WxApiRoot = 'http://8.155.60.106:8080/wx/';
// 云平台上线时使用
// var WxApiRoot = 'https://www.longyinshuiye.cn/yldswyxe/wx/';
...
module.exports = {
  ...
  AuthLoginByWxPhone: WxApiRoot + 'auth/login_by_wx_phone', //微信手机快速登录
  ...
  AuthProfile: WxApiRoot + 'auth/profile', //账号修改
  AuthReferrer: WxApiRoot + 'auth/referrer', //设置推荐人
 
  GoodsCount: WxApiRoot + 'goods/count', //统计商品总数
  GoodsList: WxApiRoot + 'goods/list', //获得商品列表
  GoodsCategory: WxApiRoot + 'goods/category', //获得分类数据
  GoodsCategoryByPid: WxApiRoot + 'goods/categoryByPid', //获得分类数据
