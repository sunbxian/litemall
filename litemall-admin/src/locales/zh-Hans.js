...
export default {
  ...
  app: {
    menu: {
      ...
      stat_grab_order_detail: '配送员订单详情',
      stat_user_order: '用户订单统计',
      stat_user_order_detail: '用户订单详情',
      stat_goods: '商品统计',
      external_link: '外链',
  ...
  mall_order: {
    ...
    form: {
      ...
      ship_sn: '快递编号',
      refund_money: '退款金额',
      ticket_count: '使用水票购买数'
    },
    placeholder: {
      filter_nickname: '请输入用户昵称',
      filter_grab_name: '请输入配送员',
      filter_consignee: '请输入收货人名称',
      filter_order_sn: '请输入订单编号',
      filter_ticket_count: '输入使用水票购买数',
